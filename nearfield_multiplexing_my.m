...
figure;fontsize =28;Linewidth =3;
hold on; box on; grid on;
plot(relativeRange, matchedfilteringGains,'k:', 'Linewidth', Linewidth);
plot(relativeRange, arrayGainFarfield,'m-.', 'Linewidth', Linewidth);
plot(relativeRange, arrayGain(:,4),'r--', 'Linewidth', Linewidth);
plot(relativeRange, arrayGain(:,3),'b-.', 'Linewidth', Linewidth);
plot(relativeRange, arrayGain(:,2),'c-', 'Linewidth', Linewidth);
plot(relativeRange, arrayGain(:,1),'g--', 'Linewidth', Linewidth);
set(gca,'XScale','log');
